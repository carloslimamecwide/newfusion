  ...
  return (
    <>
      <Section className="border-b border-line bg-bg pb-20 pt-14 sm:pb-28 sm:pt-20">
        <Link href="/servicos" className="editorial-link">
      ...
      <Section className="border-b border-line">
        <div className="grid gap-14 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <p className="mt-8 max-w-3xl font-display text-3xl font-medium leading-[1.08] tracking-[-0.04em] text-navy sm:text-5xl">{service[loc].description}</p>
          </div>
      ...
      <Section className="border-b border-line bg-surface">
        <div className="grid gap-14 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <h2 className="section-title mt-7">{t("scopeTitle")}</h2>
          </div>
          <ul className="divide-y divide-line border-y border-line lg:col-span-7 lg:col-start-6">
            {service[loc].includes.map((item, index) => (
              <li key={item} className="grid min-h-16 grid-cols-[3rem_1fr] items-center gap-4 text-fg-muted">
      ...
      <Section className="border-b border-line">
        ...
        <ol className="mt-16 grid border-y border-line sm:grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-line">
          {service[loc].process.map((step, index) => (
            <li key={step} className="min-h-52 border-b border-line py-7 sm:px-6 lg:border-b-0">
